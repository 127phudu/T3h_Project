...
@section('content')
    ...
    @endif
    <form  class="form-horizontal" action="{{ url('admin/shop/category') }}" method="post">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea  name="intro" class="form-control tinymce" id="intro" > {{ old('intro') }} </textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="desc" class="control-label col-sm-2">Mô tả: </label>
            <div class="col-sm-10">
                <textarea name="desc" class="form-control tinymce" id="desc" > {{ old('desc') }} </textarea>
            </div>
        </div>
