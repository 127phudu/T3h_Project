...
@section('content')
    <div class="w3l_banner_nav_right">
        <div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub" style="padding-top: 0!important;">
            <h3><label style="font-weight: normal">Đơn hàng của bạn</label></h3>
            <div class="w3ls_w3l_banner_nav_right_grid1">
                <div class="container">
                    ...
                    <div class="row" style="margin-bottom: 50px">
                        @foreach($products as $order_id =>$product)
                                            ...
                                            <figure>
                                                <div class="snipcart-item block">
                                                    <div class="snipcart-thumb">
                                                        ...
                                                        ?>
                                                        <a href="{{ url('/shop/payment/'.$order_id) }}" style="height: 160px"><img src="{{ asset($images[0]) }}" alt=" " class="img-responsive"></a>
                                                        <p>{{ $product->name }}</p>
                                                        <p style="margin-top: 0">Giá: {{ $product->price }} VND</p>
                                                    </div>
                                                </div>
                                            </figure>
                                        </div>
