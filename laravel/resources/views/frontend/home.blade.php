    ...
    <div class="wthree_banner_bottom_left_grid_sub1">
        <div class="col-md-4 wthree_banner_bottom_left">
            <div class="wthree_banner_bottom_left_grid">
                <img src="{{ asset('user-asset/images/4.jpg') }}" alt=" " class="img-responsive" />
        ...
        <div class="col-md-4 wthree_banner_bottom_left">
            <div class="wthree_banner_bottom_left_grid">
                <img src="{{ asset('user-asset/images/5.jpg') }}" alt=" " class="img-responsive" />
        ...
        <div class="col-md-4 wthree_banner_bottom_left">
            <div class="wthree_banner_bottom_left_grid">
                <img src="{{ asset('user-asset/images/6.jpg') }}" alt=" " class="img-responsive" />
            ...
            <div class="col-md-3 top_brand_left">
                <div class="hover14 column">
                    <div class="agile_top_brand_left_grid">
                        <div class="tag"><img src="{{ asset('user') }}" alt=" " class="img-responsive" /></div>
            ...
            <div class="col-md-9 w3l_fresh_vegetables_grid_right">
                <div class="col-md-4 w3l_fresh_vegetables_grid">
                    <div class="w3l_fresh_vegetables_grid1">
                        <img src="{{ asset('user-asset/images/8.jpg') }}" alt=" " class="img-responsive" />
                    </div>
                </div>
                <div class="col-md-4 w3l_fresh_vegetables_grid">
                    <div class="w3l_fresh_vegetables_grid1">
                        <div class="w3l_fresh_vegetables_grid1_rel">
                            <img src="{{ asset('user-asset/images/7.jpg') }}" alt=" " class="img-responsive" />
                    ...
                    <div class="w3l_fresh_vegetables_grid1_bottom">
                        <img src="{{ asset('user-asset/images/10.jpg') }}" alt=" " class="img-responsive" />
                ...
                <div class="col-md-4 w3l_fresh_vegetables_grid">
                    <div class="w3l_fresh_vegetables_grid1">
                        <img src="{{ asset('user-asset/images/9.jpg') }}" alt=" " class="img-responsive" />
                    </div>
                    <div class="w3l_fresh_vegetables_grid1_bottom">
                        <img src="{{ asset('frontend') }}" alt=" " class="img-responsive" />
                    </div>
                </div>
                <div class="clearfix"> </div>
        ...
        <div class="agile_footer_grids">
            <div class="col-md-3 w3_footer_grid agile_footer_grids_w3_footer">
                <div class="w3_footer_grid_bottom">
                    ...
                    <img src="{{ asset('user-asset/images/card.png') }}" alt=" " class="img-responsive" />
                </div>
            </div>
            <div class="col-md-3 w3_footer_grid agile_footer_grids_w3_footer">
                <div class="w3_footer_grid_bottom">
